...
export const copy = {
  "zh-CN": {
    ...
    tokenLoading: "正在统计本机历史 Token",
    tokenCurrentWindow: "当前窗口使用量",
    tokenCurrentWindowAria: (tokens: string) => `当前窗口累计使用 ${tokens} Tokens`,
    tokenCurrentWindowUnavailable: "当前窗口 Token 数据为空",
    tokenTotal: "累计使用",
    tokenTotalAria: (tokens: string) => `本机历史累计使用 ${tokens} Tokens`,
    tokenUnavailable: "暂时无法统计本机历史 Token",
    tokensUnit: "Tokens",
  ...
  en: {
    ...
    tokenLoading: "Counting local Token history",
    tokenCurrentWindow: "Current window usage",
    tokenCurrentWindowAria: (tokens: string) => `Current window usage ${tokens} Tokens`,
    tokenCurrentWindowUnavailable: "Current window Token data unavailable",
    tokenTotal: "All-time usage",
    tokenTotalAria: (tokens: string) => `Local all-time usage ${tokens} Tokens`,
    tokenUnavailable: "Local Token history unavailable",
    tokensUnit: "Tokens",
